            ...
            <div class="footer-container">
                ...
                <div class="footer-bottom">
                    ...
                    <ul class="footer-social">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars($socialLinks['facebook']); ?>" class="footer-social-link" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars($socialLinks['twitter']); ?>" class="footer-social-link" aria-label="X (Twitter)" target="_blank" rel="noopener noreferrer">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars($socialLinks['linkedin']); ?>" class="footer-social-link" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars($socialLinks['instagram']); ?>" class="footer-social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars($socialLinks['youtube']); ?>" class="footer-social-link" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
