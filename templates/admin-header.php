...
} elseif (strpos($request_uri, '/admin/smtp-settings') !== false || strpos($request_uri, '/admin/payment-settings') !== false || strpos($request_uri, '/admin/analytics-settings') !== false || strpos($request_uri, '/admin/localisation') !== false || strpos($request_uri, '/admin/database-settings') !== false) {
...
$menu_sections = [
    ...
    'settings' => [
        ...
        'items' => [
            ...
            ['url' => '/admin/analytics-settings.php', 'label' => 'Analytics & Monitoring', 'permission' => 'settings.general', 'section' => 'integrations', 'match' => '/analytics-settings'],
