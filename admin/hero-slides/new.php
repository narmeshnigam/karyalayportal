    ...
    <div class="preview-wrapper" id="previewWrapper">
        <section class="hero-slider preview-hero" aria-label="Hero Preview">
            <div class="hero-slider-container">
                <div class="hero-slide active" id="previewSlide" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="hero-slide-content">
                        <div class="container">
                            <div class="hero-content-wrapper">
                                <div class="hero-text-content">
                                    <div class="hero-highlight-text">
                                        <h1 class="hero-highlight-line" id="previewLine1">Highlight Line 1</h1>
                                        <h1 class="hero-highlight-line" id="previewLine2">Highlight Line 2</h1>
                                    </div>
                                    <p class="hero-description" id="previewDesc">Your description text will appear here...</p>
                                    <div class="hero-actions">
                                        <a href="#" class="btn btn-hero-primary btn-lg" id="previewPrimaryBtn"
                                           style="background-color: #3B82F6; color: #FFFFFF; border-color: #3B82F6;">
                                            Get Started
                                        </a>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <p class="form-help"><span class="char-count" data-for="highlight_line1">0</span>/30 characters</p>
                </div>
                <div class="form-group">
                    ...
                    <div class="color-input-wrapper">
                        ...
                        <input type="text" class="form-input color-hex-input" data-color-for="highlight_line1_color"
                               value="<?php echo htmlspecialchars($form_data['highlight_line1_color']); ?>" maxlength="7">
                    </div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group">
                    ...
                    <p class="form-help"><span class="char-count" data-for="highlight_line2">0</span>/30 characters</p>
                </div>
                <div class="form-group">
                    ...
                    <div class="color-input-wrapper">
                        ...
                        <input type="text" class="form-input color-hex-input" data-color-for="highlight_line2_color"
                               value="<?php echo htmlspecialchars($form_data['highlight_line2_color']); ?>" maxlength="7">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <div class="color-input-wrapper">
                        ...
                        <input type="text" class="form-input color-hex-input" data-color-for="description_color"
                               value="<?php echo htmlspecialchars($form_data['description_color']); ?>" maxlength="7">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="color-input-wrapper">
                            ...
                            <input type="text" class="form-input color-hex-input" data-color-for="primary_btn_bg_color"
                                   value="<?php echo htmlspecialchars($form_data['primary_btn_bg_color']); ?>" maxlength="7">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="color-input-wrapper">
                            ...
                            <input type="text" class="form-input color-hex-input" data-color-for="primary_btn_text_color"
                                   value="<?php echo htmlspecialchars($form_data['primary_btn_text_color']); ?>" maxlength="7">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="color-input-wrapper">
                            ...
                            <input type="text" class="form-input color-hex-input" data-color-for="secondary_btn_text_color"
                                   value="<?php echo htmlspecialchars($form_data['secondary_btn_text_color']); ?>" maxlength="7">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="color-input-wrapper">
                            ...
                            <input type="text" class="form-input color-hex-input" data-color-for="secondary_btn_border_color"
                                   value="<?php echo htmlspecialchars($form_data['secondary_btn_border_color']); ?>" maxlength="7">
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        btn.addEventListener('click', function() {
            ...
            if (view === 'mobile') {
                ...
                if (mobileImg || desktopImg) {
                    ...
                    previewSlide.style.background = '';
                }
            } else {
                previewWrapper.classList.remove('mobile-view');
                const desktopImg = document.getElementById('image_url').value;
                if (desktopImg) {
                    previewSlide.style.backgroundImage = `url('${desktopImg}')`;
                    previewSlide.style.background = '';
                }
            }
        });
    ...
    document.getElementById('image_url')?.addEventListener('input', function() {
        if (!previewWrapper.classList.contains('mobile-view') && this.value) {
