...
CREATE TABLE IF NOT EXISTS solution_styling (
    ...
    hero_badge VARCHAR(36) DEFAULT NULL,
    hero_title_text VARCHAR(24) DEFAULT NULL,
    hero_title_color VARCHAR(20) DEFAULT '#FFFFFF',
    hero_subtitle_color VARCHAR(20) DEFAULT '#FFFFFF',
    hero_media_url VARCHAR(100) DEFAULT NULL,
    hero_media_type ENUM('image', 'gif', 'video') DEFAULT 'image',
    hero_bg_color VARCHAR(20) DEFAULT '#0a1628',
    hero_bg_gradient_color VARCHAR(20) DEFAULT NULL,
    ...
    hero_cta_primary_link VARCHAR(100) DEFAULT NULL,
    hero_cta_secondary_text VARCHAR(100) DEFAULT 'Watch Demo',
    hero_cta_secondary_link VARCHAR(100) DEFAULT NULL,
    
    -- Hero Primary Button Colors
    hero_primary_btn_bg_color VARCHAR(20) DEFAULT '#ffffff26',
    hero_primary_btn_text_color VARCHAR(20) DEFAULT '#FFFFFF',
    hero_primary_btn_text_hover_color VARCHAR(20) DEFAULT '#FFFFFF',
    hero_primary_btn_border_color VARCHAR(20) DEFAULT '#ffffff4d',
    
    -- Hero Secondary Button Colors
    hero_secondary_btn_bg_color VARCHAR(20) DEFAULT '#ffffff1a',
    hero_secondary_btn_text_color VARCHAR(20) DEFAULT '#FFFFFF',
    hero_secondary_btn_text_hover_color VARCHAR(20) DEFAULT '#FFFFFF',
    hero_secondary_btn_border_color VARCHAR(20) DEFAULT '#ffffff33',
    
    -- Key Benefits Section Styling
    key_benefits_section_enabled BOOLEAN DEFAULT FALSE,
    key_benefits_section_bg_color VARCHAR(20) DEFAULT '#0a1628',
    ...
    key_benefits_section_heading_color VARCHAR(20) DEFAULT '#FFFFFF',
    key_benefits_section_subheading_color VARCHAR(20) DEFAULT '#ffffffb3',
    key_benefits_section_card_bg_color VARCHAR(20) DEFAULT '#ffffff14',
    key_benefits_section_card_border_color VARCHAR(20) DEFAULT '#ffffff1a',
    key_benefits_section_card_hover_bg_color VARCHAR(20) DEFAULT '#2563eb',
    key_benefits_section_card_text_color VARCHAR(20) DEFAULT '#FFFFFF',
    key_benefits_section_card_icon_color VARCHAR(20) DEFAULT '#ffffff99',
    ...
    feature_showcase_section_bg_color VARCHAR(20) DEFAULT '#ffffff',
    feature_showcase_section_title_color VARCHAR(20) DEFAULT '#1a202c',
    feature_showcase_section_subtitle_color VARCHAR(20) DEFAULT '#718096',
    feature_showcase_card_bg_color VARCHAR(20) DEFAULT '#ffffff',
    feature_showcase_card_border_color VARCHAR(20) DEFAULT '#e2e8f0',
    feature_showcase_card_badge_bg_color VARCHAR(20) DEFAULT '#ebf8ff',
    feature_showcase_card_badge_text_color VARCHAR(20) DEFAULT '#2b6cb0',
    feature_showcase_card_heading_color VARCHAR(20) DEFAULT '#1a202c',
    feature_showcase_card_text_color VARCHAR(20) DEFAULT '#4a5568',
    feature_showcase_card_icon_color VARCHAR(20) DEFAULT '#38a169',
    
    -- CTA Banner Section Styling
    cta_banner_enabled BOOLEAN DEFAULT TRUE,
    cta_banner_image_url VARCHAR(100) DEFAULT NULL,
    cta_banner_overlay_color VARCHAR(20) DEFAULT '#00000080',
